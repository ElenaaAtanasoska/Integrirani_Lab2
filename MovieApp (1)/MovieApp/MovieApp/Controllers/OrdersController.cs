        ...
        */
        ...
        public async Task<IActionResult> DeleteProductFromShoppingCart(Guid? productId)
        {
            ...
            if(userId != null)
            {
                ...
                var tickets_to_delete = loggedInUser?.UserOrder.TicketInOrders.First(z => z.TicketId == productId);
                loggedInUser?.UserOrder.TicketInOrders.Remove(tickets_to_delete);
